...
it.each([
    ...
    ['col-span-0', ''],
])('generates grid-row and grid-column utilities (%s)', testUtility);
...
it.each([
    ...
    ['col-start-0', ''],
    ['-col-start-0', ''],
])('generates grid-row-start and grid-column-start utilities (%s)', testUtility);
...
it.each([
    ...
    ['col-end-0', ''],
    ['-col-end-0', ''],
])('generates grid-row-end and grid-column-end utilities (%s)', testUtility);
...
])('generates grid-auto-rows and grid-auto-columns utilities (%s)', testUtility);
